...
Desenvolvedor Pleno com foco em **Backend**, atuando principalmente com **Node.js, TypeScript, NestJS e Express**.

Tenho experiência no desenvolvimento de APIs, integrações financeiras, sistemas SaaS, e-commerce, BaaS, subadquirência, gateways de pagamento, adquirentes, bancos e operadoras de cartão de crédito.

---

## Sobre mim

* Backend Developer com foco em **Node.js e TypeScript**
* Experiência com **NestJS, Express, AWS, PostgreSQL, Redis e filas**
* Atuação com integrações de APIs financeiras, adquirentes e gateways
* Experiência com serviços AWS como **Lambda, SQS, SNS, ECS e Fargate**
* Conhecimento em frontend com **React e Next.js**
* Experiência complementar com **React Native, PHP e Laravel**
...
![AWS Fargate](https://img.shields.io/badge/AWS_Fargate-232F3E?style=for-the-badge\&logo=amazonaws\&logoColor=white)
...
* Deploy de aplicações com ECS e Fargate
...
> Backend, cloud e integrações financeiras com foco em escalabilidade, segurança e manutenção.
